...
@implementation GameOverWINLayer

// Helper class method that creates a Scene with the GameOverWINLayer as the only child.
+(CCScene *) scene
{
	...
	GameOverWINLayer *layer = [GameOverWINLayer node];
